...
internal class RouteStackManager(
  ...
  private val _suspendResult = linkedMapOf<NavBackStackEntry, Continuation<Any?>>()
  ...
  internal val currentEntry: NavBackStackEntry?
  ...
  suspend fun waitingForResult(entry: NavBackStackEntry): Any? = suspendCoroutine {
